...
public class HODActivity extends AppCompatActivity implements listAdapter.listListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                auth.signOut();
                startActivity(new Intent(HODActivity.this, LoginActivity.class));
                finish();
                return true;
            default:
